...
class R1Details extends StatelessWidget {
  const R1Details({Key? key}) : super(key: key);
...
class R1DetailsUI extends StatefulWidget {
  const R1DetailsUI({Key? key}) : super(key: key);

  @override
  _R1DetailsUIState createState() => _R1DetailsUIState();
}

class _R1DetailsUIState extends State<R1DetailsUI> {

import 'package:bikerent/bikeDetails/hayabusa.dart';
...
class HayabusaDetails extends StatelessWidget {
  const HayabusaDetails({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return MaterialApp(
      home: HayabusaDetailsUI(),
    );
  }
}

class HayabusaDetailsUI extends StatefulWidget {
  const HayabusaDetailsUI({Key? key}) : super(key: key);

  @override
  _HayabusaDetailsUIState createState() => _HayabusaDetailsUIState();
}

class _HayabusaDetailsUIState extends State<HayabusaDetailsUI> {

...
class S1000RRDetails extends StatelessWidget {
  const S1000RRDetails({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return MaterialApp(
      home: S1000RRDetailsUI(),
    );
  }
}

class S1000RRDetailsUI extends StatefulWidget {
  const S1000RRDetailsUI({Key? key}) : super(key: key);

  @override
  _S1000RRDetailsUIState createState() => _S1000RRDetailsUIState();
}

class _S1000RRDetailsUIState extends State<S1000RRDetailsUI> {
                            ...
                            child: Container(
                              ...
                              decoration: BoxDecoration(
                                  ...
                                  image: DecorationImage(
                                      image:
                                          AssetImage("assets/images/bmw2.png"),
                                      fit: BoxFit.contain)),
                            ),
                          ),
                          Padding(
                            ...
                            child: Container(
                              ...
                              decoration: BoxDecoration(
                                  ...
                                  image: DecorationImage(
                                      image:
                                          AssetImage("assets/images/bmw3.png"),
                                      fit: BoxFit.contain)),
                            ),
                          ),
                          Padding(

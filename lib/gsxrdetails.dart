...
class GSXRDetails extends StatelessWidget {
  const GSXRDetails({Key? key}) : super(key: key);
...
class GSXRDetailsUI extends StatefulWidget {
  const GSXRDetailsUI({Key? key}) : super(key: key);

  @override
  _GSXRDetailsUIState createState() => _GSXRDetailsUIState();
}

class _GSXRDetailsUIState extends State<GSXRDetailsUI> {
                            ...
                            child: Container(
                              ...
                              decoration: BoxDecoration(
                                  ...
                                  image: DecorationImage(
                                      image:
                                          AssetImage("assets/images/gsxr2.png"),
                                      fit: BoxFit.contain)),
                            ),
                          ),
                          Padding(
                            ...
                            child: Container(
                              ...
                              decoration: BoxDecoration(
                                  ...
                                  image: DecorationImage(
                                      image:
                                          AssetImage("assets/images/gsxr3.png"),
                                      fit: BoxFit.contain)),
                            ),
                          ),
                          Padding(

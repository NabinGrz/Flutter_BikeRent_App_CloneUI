import 'package:bikerent/bikeDetails/CBR.dart';
...
class CBRDetails extends StatelessWidget {
  const CBRDetails({Key? key}) : super(key: key);
...
class CBRDetailsUI extends StatefulWidget {
  const CBRDetailsUI({Key? key}) : super(key: key);

  @override
  _CBRDetailsUIState createState() => _CBRDetailsUIState();
}

class _CBRDetailsUIState extends State<CBRDetailsUI> {
                            ...
                            child: Container(
                              ...
                              decoration: BoxDecoration(
                                  ...
                                  image: DecorationImage(
                                      image:
                                          AssetImage("assets/images/cbr.png"),
                                      fit: BoxFit.contain)),
                            ),
                          ),
                          Padding(

...
import 'package:bikerent/bikeDetails/v4.dart';
...
class BikeDetailsUI extends StatefulWidget {
  const BikeDetailsUI({Key? key}) : super(key: key);

  @override
  _BikeDetailsUIState createState() => _BikeDetailsUIState();
}

class _BikeDetailsUIState extends State<BikeDetailsUI> {
                ...
                TableCalendar(
                  ...
                  calendarStyle: CalendarStyle(
                      selectedDecoration: BoxDecoration(
                          color: Color(0xFFFF6016), shape: BoxShape.circle),
                      ...
                      todayDecoration: BoxDecoration(
                          color: Color(0xFF0019FA), shape: BoxShape.circle)),
  ...
  Widget build(BuildContext context) {
    ...
    return MaterialApp(
      ...
      home: Scaffold(
        appBar: AppBar(
          toolbarHeight: 80,
          backgroundColor: isDark ? Colors.black : Color(0xC0FFFFFF),
          title: Row(
        ...
        body: Container(
            ...
            decoration: BoxDecoration(
                ...
                // color: Color(Color(0xC0FF0000) ),
                color: isDark ? Colors.black : Color(0xC0E4E4E4)
                // ]
                ),
                  ...
                  Padding(
                    ...
                    child: Align(
                      ...
                      child: Text(
                        ...
                        style: TextStyle(
                            fontSize: 30,
                            color: isDark ? Color(0xC0E4E4E4) : Colors.black,
                        ...
                        items: <Widget>[
                          ...
                          Padding(
                            ...
                            child: InkWell(
                              onTap: () {
                                setState(() {
                                  _control.value = Matrix4
                                      .identity(); //to not zzom the other image selected
                                });
                              },
                              child: Container(
                                height:
                                ...
                                decoration: BoxDecoration(
                                    ...
                                    image: DecorationImage(
                                        image:
                                            AssetImage("assets/images/v43.png"),
                                        fit: BoxFit.contain)),
                              ),
                            ),
                          ),
                      ...
                      child: Padding(
                        ...
                        child: Text(
                          ...
                          style: TextStyle(
                            ...
                            fontWeight: FontWeight.w500,
                            color:
                                isDark ? Color(0xC0E4E4E4) : Color(0xC0000000),
                          ),
                        ),
                      ),
                    ),

...
class RSV4Details extends StatelessWidget {
  const RSV4Details({Key? key}) : super(key: key);
...
class RSV4DetailsUI extends StatefulWidget {
  const RSV4DetailsUI({Key? key}) : super(key: key);

  @override
  _RSV4DetailsUIState createState() => _RSV4DetailsUIState();
}

class _RSV4DetailsUIState extends State<RSV4DetailsUI> {
                            ...
                            child: Container(
                              ...
                              decoration: BoxDecoration(
                                  ...
                                  image: DecorationImage(
                                      image:
                                          AssetImage("assets/images/rsv42.png"),
                                      fit: BoxFit.contain)),
                            ),
                          ),
                          Padding(
